...
private:
    ...
    string FileName2 = "TransferLog.txt";
    ...
    static stTransferLog _ConvertTransferLogLineToRecord(string Line, string  Spreater = "/##/") {

        vector <string > vTransferLog = clsString::Split(Line, Spreater);

        stTransferLog TransferLog;
        
        TransferLog.DateTime = vTransferLog[0];
        TransferLog.SourseAccount = vTransferLog[1];
        TransferLog.DestinationAccount = vTransferLog[2];
        TransferLog.Amount = stof(vTransferLog[3]);
        TransferLog.SourseBalance = stof(vTransferLog[4]);
        TransferLog.DestinationBalance = stof(vTransferLog[5]);
...
public:
    ...
    static vector <stTransferLog> GetTransferLogHistory() {
